# Any time opens a new terminal for this project, run:
...
STATE_DIR = os.path.join(BASE_DIR, "state") #It creates a variable named STATE_DIR that points to a folder called state inside of project folder.
